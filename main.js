 ...
 ****************************************************/
const API_URL =
  "https://script.google.com/macros/s/AKfycbxgidwuQo9UTNHrb85ZFbY7YyKGWxR1HHLtLGpfbu4ILyMGHbSj7b0XrYSCsZEv8XjW/exec";
...
const parseds = parseLoggedInUser(raw);

if (parseds?.rawObj?.loginTime) {
  const now = Date.now();
  if (now - parseds.rawObj.loginTime > MAX_TIME) {
